...
contract TokenIDResolver is ResolverBase {
    bytes4 constant private TOKENID_INTERFACE_ID = 0x80ac58cd;
    ...
    function setTokenID(bytes32 node, uint256 tokenID) public authorised(node) {
        emit TokenIDChanged(node, tokenID);
